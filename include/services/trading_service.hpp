...
namespace services
{
    ...
    public:
        ...
        utils::ServiceResult<std::vector<CandlestickData>> GetCandlestickData(std::string_view currency_base,
        ...
        utils::ServiceResult<CandlestickSummaryData> GetCandlestickSummary(std::string_view currency_base,
                                                                           std::string_view currency_quote,
                                                                           dto::OrderType order_type,
                                                                           dto::Timeframe timeframe,
                                                                           const std::optional<utils::TimePoint> &start_date,
