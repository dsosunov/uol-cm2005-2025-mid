...
class UserRegisterAction
    : public actions::FormBasedAction<user_forms::RegistrationForm, dto::UserRegistration,
                                      utils::ServiceResult<services::User>>
{
  ...
  protected:
    ...
    utils::ServiceResult<services::User> ExecuteService(const dto::UserRegistration& data,
                                                        ActionContext& context) override;
    void DisplayResults(const utils::ServiceResult<services::User>& result,
                        const dto::UserRegistration& data, ActionContext& context) override;
