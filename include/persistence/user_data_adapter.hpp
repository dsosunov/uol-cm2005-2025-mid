...
namespace persistence
{
    ...
    public:
        ...
        bool Insert(services::UserRecord &user);
        bool Update(const services::UserRecord &user);

    protected:
        std::optional<services::UserRecord> TransformToEntity(const data::CsvRecord &record) const override;
